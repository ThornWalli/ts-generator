 ...
 * @returns {function(Observable<number>): Observable<number>} A function that takes an Observable and returns an Observable.
 */
...
export function power(value: number) {
  return (source: Observable<number>): Observable<number> => source.pipe(map(v => Math.pow(v, value)));
}
...
export function sqrt() {
  return (source: Observable<number>): Observable<number> => source.pipe(map(v => Math.sqrt(v)));
}
 ...
 */
export function log() {
  return (source: Observable<number>): Observable<number> => source.pipe(map(v => Math.log10(v)));
}
 ...
 */
export function ln() {
  return (source: Observable<number>): Observable<number> => source.pipe(map(v => Math.log(v)));
}
 ...
 */
export function sin() {
  return (source: Observable<number>): Observable<number> => source.pipe(map(v => Math.sin(v)));
}
 ...
 */
export function cos() {
  return (source: Observable<number>): Observable<number> => source.pipe(map(v => Math.cos(v)));
}
 ...
 */
export function tan() {
  return (source: Observable<number>): Observable<number> => source.pipe(map(v => Math.tan(v)));
}
